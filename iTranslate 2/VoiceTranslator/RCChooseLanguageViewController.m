...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(nil == cell)
    {
        cell = [[[RCChooseLanguageCell alloc] initWithStyle: UITableViewCellStyleDefault
    ...
    if(language)
    {
        ...
        RCChooseLanguageCell* temp = (RCChooseLanguageCell*)cell;
        if(temp)
        {
            [temp updateContent:language];
        }
    }
